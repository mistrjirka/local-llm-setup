...
BATCH_SIZE=${ORNITH15_BATCH_SIZE:-512}
UBATCH_SIZE=${ORNITH15_UBATCH_SIZE:-128}
DRAFT_UBATCH_SIZE=${ORNITH15_DRAFT_UBATCH_SIZE:-64}
MTP_N_MAX=${ORNITH15_MTP_N_MAX:-1}
MTP_DEVICE=${ORNITH15_MTP_DEVICE:-CUDA1,CUDA0}
...
export LLAMA_MTP_SHARE_TARGET_IO=${LLAMA_MTP_SHARE_TARGET_IO:-head}
